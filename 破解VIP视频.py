...
class APP:
    def __init__(self, width=700, height=300):
        ...
        # 各大视频网站
        moviemenu.add_command(label='腾讯视频', command=lambda: webbrowser.open('https://v.qq.com/'))
        moviemenu.add_command(label='搜狐视频', command=lambda: webbrowser.open('https://tv.sohu.com/'))
        moviemenu.add_command(label='芒果TV', command=lambda: webbrowser.open('https://www.mgtv.com/'))
        moviemenu.add_command(label='爱奇艺', command=lambda: webbrowser.open('https://www.iqiyi.com/'))
        moviemenu.add_command(label='PPTV', command=lambda: webbrowser.open('https://www.bilibili.com/'))
        moviemenu.add_command(label='优酷', command=lambda: webbrowser.open('https://www.youku.com/'))
        moviemenu.add_command(label='乐视', command=lambda: webbrowser.open('https://www.le.com/'))
        moviemenu.add_command(label='土豆', command=lambda: webbrowser.open('https://www.tudou.com/'))
        moviemenu.add_command(label='A站', command=lambda: webbrowser.open('https://www.acfun.cn/'))
        moviemenu.add_command(label='B站', command=lambda: webbrowser.open('https://www.bilibili.com/'))
        ...
        label4 = tk.Label(frame_4, text=" ")
        label5 = tk.Label(frame_4, text=" ")
    ...
    def video_play(self):
        ...
        port_1 = 'https://svip.bljiex.cc/index.php?url='
        port_2 = 'https://api.jiexi.la/?url='
        port_3 = 'https://www.ckmov.vip/api.php?url='

        port_4 = 'https://api.okjx.cc:3389/jx.php?url='
        port_5 = 'https://jx.jsonplayer.com/player/?url='
