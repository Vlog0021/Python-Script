...
class SetUI(object):
    ...
    def __init__(self, weight=850, height=600):
    ...
    def set_ui(self):
        ...
        passageway_button_1 = tk.Radiobutton(frame_1, text='网易云', variable=self.ui_var, value=2, width=10, height=3)
        passageway_button_2 = tk.Radiobutton(frame_1, text='酷我', variable=self.ui_var, value=1, width=10, height=3)
